...
Escopo posterior: aplicar [política compartilhada](../../docs/REGRAS_ESCOPO_SLA.md)
escopo-sla-v3. Input comprovadamente vazio entra; ausência de contexto histórico
exclui o projeto do SLA viu2 e da trajetória consolidada. Na origem diária,
cadastro/célula/rótulo não verificável exclui o projeto inteiro. Coluna global
ausente ou ambígua e dados malformados bloqueiam publicação. Não muda schema ou IDs.
